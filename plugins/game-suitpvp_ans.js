...
klik wa.me/${conn.user.jid.split`@`[0]}`, m.chat, {
      ...
      if (!room.pilih) conn.sendMessage(room.p, 'Silahkan pilih', `Menang +${room.poin}XP\nKalah -${room.poin_lose}XP`, 'Batu', 'Kertas',  'Gunting', m)
      if (!room.pilih2) conn.sendMessage(room.p2, 'Silahkan pilih', `Menang +${room.poin}XP\nKalah -${room.poin_lose}XP`, 'Batu', 'Kertas', 'Gunting', m)
